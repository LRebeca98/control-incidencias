...
public final class DLLUsuario {
    ...
    public List<Usuario> listar() {
        String sql = "SELECT usuarios.id AS id, usuarios.user AS user, usuarios.pass AS pass, usuarios.avatar AS avatar, usuarios.perfil AS perfil, perfiles.info AS perfil_info FROM usuarios INNER JOIN perfiles ON perfiles.id = usuarios.perfil ";
